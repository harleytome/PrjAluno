...
<form name="formdata" method="POST" action="myinfo.store">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-5 col-lg-4">
            <input name="alias" id="alias" type="text" class="form-control" value="{{$studant->alias}}">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-2 col-lg-2">
            <select name="use_alias" id="use_alias" class="form-control">
                <option value="N"
                @if( $studant->use_alias == 'N')
                selected
                @endif
                >Não</option>
                <option value="S"
                @if( $studant->use_alias == 'S')
                selected
                @endif
                >Sim</option>
            </select>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-4 col-lg-3">
            <input name="birthdate" id="birthdate" type="date" value="{{$studant->birthdate}}" class="form-control @if($errors->has('birthdate')) is-invalid @endif">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-2 col-lg-1">
            <input name="class_name" id="class_name" type="text" value="{{$studant->class_name}}" class="form-control @if($errors->has('class_name')) is-invalid @endif" maxlength="2" style="text-transform:uppercase">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-2 col-lg-2">
            <input name="current_year" id="current_year" type="number" maxlength="4" value="{{$studant->current_year}}" class="form-control @if($errors->has('current_year')) is-invalid @endif">
